...
const CURRENT_TECH_STACK: TechStackItem[] = [
  { name: 'TypeScript', domain: 'web', icon: '/svg/typescript.svg', hoverColor: 'group-hover:text-typescript' },
  ...
  { name: 'Tailwind', domain: 'web', icon: '/svg/tailwind.svg', hoverColor: 'group-hover:text-tailwind' },
  ...
  { name: 'Firebase', domain: 'server', icon: '/svg/firebase.svg', hoverColor: 'group-hover:text-firebase' },
  { name: 'Playwright', domain: 'web', icon: '/svg/playwright.svg', hoverColor: 'group-hover:text-playwright' },
];
