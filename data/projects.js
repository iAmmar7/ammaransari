const projects = [
  ...
  },
  {
    ...
    domain: 'challenge',
    technologies: ['TypeScript', 'Node JS', 'JEST', 'Vite', 'Monorepo', 'Turborepo'],
  ...
  },
  {
    ...
    contribution: [
      '<p>Responsible to build and streamline the whole flow of “pay with careem” with other team members.</p>',
      '<p>Integration with bank cards and handle the scenario of both 3DS and Non-3DS cards.</p>',
      '<p>Reduced the bundle size by code splitting for different application flows.</p>',
      '<p>Integrated the crash reporting library in payment module.</p>',
      '<p>Successfully deployed the server-side rendered application using the <strong>CI/CD</strong> pipeline with GitLab</p>',
      '<p>Improved the app performance by creating a separate package to implement a <strong>queue</strong> for analytics APIs.</p>',
    ],
  ...
  },
  {
    ...
    domain: 'side-project',
    technologies: ['React JS', 'Next JS', 'Tailwind', 'Framer Motion'],
