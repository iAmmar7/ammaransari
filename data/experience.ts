...
export const experience: Experience[] = [
    ...
    summary: [
      ...
      },
      {
        ...
        summary: [
          ...
          "Reduced application load time by 15% through strategic code splitting and deployed a server-side rendered application via GitLab's CI/CD pipeline.",
  ...
  },
  {
    ...
    summary: [
      'Building and maintaining Node.js server with Express.js and Mongoose.js ODM for MongoDB database.',
      'Responsible for database designing and maintaining.',
      'Develop a new UI with a step-by-step user flow and graphical insight.',
      'Integrating backend server with frontend using React, Redux, etc.',
  ...
  },
  {
    ...
    location: 'Karachi, Pakistan',
    summary: [
      'Front end web app development using CSS, Sass, Bootstrap, Vanilla JavaScript and React.js.',
