const skills = [
  ...
  { name: 'Next JS', ratings: 3.5, major: true, priority: 2, domain: 'web' },
  { name: 'WebRTC', ratings: 3, major: true, priority: 7, domain: 'web' },
  { name: 'Redux', ratings: 3, major: true, priority: 4, domain: 'web' },
  { name: 'Redux Saga', ratings: 3, major: true, domain: 'web' },
  ...
  { name: 'Playwright', ratings: 2.5, major: true, domain: 'web' },
