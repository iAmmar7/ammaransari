  ...
  return (
    <div className='relative block items-start rounded-full border-white border-opacity-20 first:mt-0 md:flex'>
      {date ? (
        ...
        <span className='absolute top-0 left-12 mt-7 mr-12 min-w-[160px] rounded-full bg-transparent bg-opacity-10 p-1 text-center text-sm leading-none md:relative md:left-0' />
      )}
      <div className={clsx('relative border-l-4 border-white border-opacity-20 pt-16 pl-12 md:pt-6', !date && 'pt-6')}>
        <span className='absolute -left-0.5 top-0 mt-1 h-full w-0 rounded-full bg-white bg-opacity-20'>
          ...
          <span
            className={clsx(
              'absolute left-0 right-full top-6 -z-10 mt-2.5 h-1 w-8 translate-x-0 transform rounded-full bg-white bg-opacity-20',
