          ...
          {CURRENT_TECH_STACK.map((tech) => {
            ...
            return (
              <Link
                ...
                passHref
              >
                <a className='group relative bg-muted cursor-pointer rounded-base shadow-md backdrop-blur-md transition-all ease-base duration-md hover:translate-x-0 hover:-translate-y-1.5 hover:rotate-0 hover:skew-x-0 hover:skew-y-0 hover:scale-x-100 hover:scale-y-100'>
                  <SVG.Component
                    className={clsx(
